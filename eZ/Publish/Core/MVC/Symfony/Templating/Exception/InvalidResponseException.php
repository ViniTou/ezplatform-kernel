...
class InvalidResponseException extends ForbiddenException implements Translatable
{
    ...
    {
        $this->setMessageTemplate('Response is invalid: %whatIsWrong%');
        $this->setParameters(['%whatIsWrong%' => $whatIsWrong]);
        parent::__construct($this->getMessageTemplate(), $this->getParameters());
    }
}
